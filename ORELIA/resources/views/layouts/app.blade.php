...
<head>
    ...
    <style>
        ...
        * { font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        .card:hover { transform: translateY(-8px); box-shadow: 0 12px 35px rgba(212, 165, 165, 0.2); }
        ...
        .btn:hover { transform: translateY(-3px); box-shadow: 0 6px 18px rgba(212, 165, 165, 0.25); }
        .btn-primary { background: linear-gradient(135deg, var(--primary-rosa) 0%, var(--rosa-oscuro) 100%); color: var(--text-taupe); }
        .btn-primary:hover { background: linear-gradient(135deg, var(--rosa-oscuro) 0%, #c9a0a0 100%); color: var(--text-taupe); }
...
.btn-warning:hover { background: #EDD96B; color: var(--text-taupe); }
        ...
        .table thead th { border: none; border-bottom: 2px solid var(--secondary-oro); padding: 1.2rem; letter-spacing: 0.5px; }
        ...
        .alert-dismissible .btn-close { color: var(--text-taupe); }

        /* Forms */
        .form-control, .form-control:focus { border: 2px solid #f0e5ec; border-radius: 8px; padding: 0.7rem 1rem; transition: all 0.3s ease; }
        .form-control:focus { border-color: var(--primary-rosa); box-shadow: 0 0 0 0.2rem rgba(245, 213, 224, 0.25); background-color: var(--rosa-claro); }
        ...
        a { color: var(--rosa-oscuro); text-decoration: none; transition: all 0.2s ease; }
        a:hover { color: var(--secondary-oro); text-decoration: underline; }
        h1,h2,h3 { color: var(--text-taupe); font-weight: 700; letter-spacing: 0.5px; }
    </style>
</head>
<body>
